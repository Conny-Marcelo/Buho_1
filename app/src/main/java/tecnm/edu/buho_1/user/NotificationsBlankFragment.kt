...
class NotificationsBlankFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_post_blank, container, false)

        val retryButton: Button = view.findViewById(R.id.btnRetryN)
