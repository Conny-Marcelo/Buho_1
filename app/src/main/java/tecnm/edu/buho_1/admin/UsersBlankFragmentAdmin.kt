...
class UsersBlankFragmentAdmin : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_users_blank_admin, container, false)
        ...
        retryButton.setOnClickListener {
            if (isInternetAvailable(requireContext())) { //Garantizar que la aplicación solo realice acciones que requieren una conexión a Internet cuando esté disponible
                navController.navigate(R.id.usuariosReportesAdmin)
            }
        }
